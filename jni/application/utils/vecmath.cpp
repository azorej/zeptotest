...
mat3 mat3::operator *(const mat3& rhs) const
{
	...
	ret.f[0] = f[0] * rhs.f[0] + f[3] * rhs.f[1] + f[6] * rhs.f[2];
	ret.f[1] = f[1] * rhs.f[0] + f[4] * rhs.f[1] + f[7] * rhs.f[2];
	ret.f[2] = f[2] * rhs.f[0] + f[5] * rhs.f[1] + f[8] * rhs.f[2];
	ret.f[3]  = f[0] * rhs.f[3] + f[3] * rhs.f[4] + f[6] * rhs.f[5];
	ret.f[4]  = f[1] * rhs.f[3] + f[4] * rhs.f[4] + f[7] * rhs.f[5];
	ret.f[5]  = f[2] * rhs.f[3] + f[5] * rhs.f[4] + f[8] * rhs.f[5];
	ret.f[6]  = f[0] * rhs.f[6] + f[3] * rhs.f[7] + f[6] * rhs.f[8];
	ret.f[7]  = f[1] * rhs.f[6] + f[4] * rhs.f[7] + f[7] * rhs.f[8];
	ret.f[8]  = f[2] * rhs.f[6] + f[5] * rhs.f[7] + f[8] * rhs.f[8];
...
vec3 mat3::operator *(const vec3& rhs) const
{
	...
	ret.x = rhs.x * f[0] + rhs.y * f[3] + rhs.z * f[6];
	ret.y = rhs.x * f[1] + rhs.y * f[4] + rhs.z * f[7];
...
mat3 mat3::view_to_world(float coordinate_factor, float aspect_ratio)
{
	...
	{
		x_f = 1.f/aspect_ratio;
		y_f = 1.f;
	}

	mat3 ret;
	ret.f[0] = 2.f*x_f/coordinate_factor;
	ret.f[3] = 0.0f;
	ret.f[6] = 0.0f;
	ret.f[1] = 0.0f;
	ret.f[4] = 2.f*y_f/coordinate_factor;
	ret.f[7] = 0.0f;
	ret.f[2] = 0.0f;
	ret.f[5] = 0.0f;
	ret.f[8] = 1.0f;
...
mat3 mat3::translation(const float fX, const float fY)
{
	mat3 ret;
	ret.f[0] = 1.f;
	ret.f[3] = 0.0f;
...
mat4 mat4::operator*(const mat4& rhs) const {
	mat4 ret;
	ret.f[0] = f[0] * rhs.f[0] + f[4] * rhs.f[1] + f[8] * rhs.f[2]
			+ f[12] * rhs.f[3];
	ret.f[1] = f[1] * rhs.f[0] + f[5] * rhs.f[1] + f[9] * rhs.f[2]
			+ f[13] * rhs.f[3];
	ret.f[2] = f[2] * rhs.f[0] + f[6] * rhs.f[1] + f[10] * rhs.f[2]
			+ f[14] * rhs.f[3];
	ret.f[3] = f[3] * rhs.f[0] + f[7] * rhs.f[1] + f[11] * rhs.f[2]
			+ f[15] * rhs.f[3];
	ret.f[4] = f[0] * rhs.f[4] + f[4] * rhs.f[5] + f[8] * rhs.f[6]
			+ f[12] * rhs.f[7];
	ret.f[5] = f[1] * rhs.f[4] + f[5] * rhs.f[5] + f[9] * rhs.f[6]
			+ f[13] * rhs.f[7];
	ret.f[6] = f[2] * rhs.f[4] + f[6] * rhs.f[5] + f[10] * rhs.f[6]
			+ f[14] * rhs.f[7];
	ret.f[7] = f[3] * rhs.f[4] + f[7] * rhs.f[5] + f[11] * rhs.f[6]
			+ f[15] * rhs.f[7];
	ret.f[8] = f[0] * rhs.f[8] + f[4] * rhs.f[9] + f[8] * rhs.f[10]
			+ f[12] * rhs.f[11];
	ret.f[9] = f[1] * rhs.f[8] + f[5] * rhs.f[9] + f[9] * rhs.f[10]
			+ f[13] * rhs.f[11];
	ret.f[10] = f[2] * rhs.f[8] + f[6] * rhs.f[9] + f[10] * rhs.f[10]
			+ f[14] * rhs.f[11];
	ret.f[11] = f[3] * rhs.f[8] + f[7] * rhs.f[9] + f[11] * rhs.f[10]
			+ f[15] * rhs.f[11];
	ret.f[12] = f[0] * rhs.f[12] + f[4] * rhs.f[13] + f[8] * rhs.f[14]
			+ f[12] * rhs.f[15];
	ret.f[13] = f[1] * rhs.f[12] + f[5] * rhs.f[13] + f[9] * rhs.f[14]
			+ f[13] * rhs.f[15];
	ret.f[14] = f[2] * rhs.f[12] + f[6] * rhs.f[13] + f[10] * rhs.f[14]
			+ f[14] * rhs.f[15];
	ret.f[15] = f[3] * rhs.f[12] + f[7] * rhs.f[13] + f[11] * rhs.f[14]
			+ f[15] * rhs.f[15];
	return ret;
}
...
mat4 mat4::perspective(float width, float height, float nearPlane,
	...
	result.f[12] = 0;
	result.f[1] = 0;
	result.f[5] = n2 / height;
	result.f[9] = 0;
	result.f[13] = 0;
	result.f[2] = 0;
	result.f[6] = 0;
	result.f[10] = (farPlane + nearPlane) * rcpnmf;
	result.f[14] = farPlane * rcpnmf * n2;
	result.f[3] = 0;
	result.f[7] = 0;
	result.f[11] = -1.0;
	result.f[15] = 0;
...
mat4 mat4::lookAt(const vec3& vEye, const vec3& vAt, const vec3& vUp) {
	...
	result.f[8] = vSide.z;
	result.f[12] = 0;
	result.f[1] = vUpNorm.x;
	result.f[5] = vUpNorm.y;
	result.f[9] = vUpNorm.z;
	result.f[13] = 0;
	result.f[2] = vForward.x;
	result.f[6] = vForward.y;
	result.f[10] = vForward.z;
	result.f[14] = 0;
	result.f[3] = 0;
	result.f[7] = 0;
	result.f[11] = 0;
