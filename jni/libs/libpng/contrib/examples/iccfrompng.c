    ...
    *proflen = 0;
...

    {
                ...
                proflen) & PNG_INFO_iCCP)
        {
            ...
            if (result != NULL) memcpy(result, profile, *proflen);
...
static int extract_one_file(const char *filename)
{
    ...
    if (fp != NULL)
    {
            ...
            if (output != NULL)
            {
                ...
                if (of != NULL)
                {
                    ...
                    else
                    {
                        ...
                        if (remove(output)) fprintf(stderr,
        ...
        else if (verbose && profile == no_profile) printf("%s has no profile\n",
                filename);
    }
...
int main(int argc, char **argv)
{
    ...
    for (i = 1; i < argc; ++i)
    {
        ...
        else if (extract_one_file(argv[i])) extracted = 1;
    }
