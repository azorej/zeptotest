...
int writepng_init(mainprog_info *mainprog_ptr)
{
    ...
    if (mainprog_ptr->pnmtype == 5) color_type = PNG_COLOR_TYPE_GRAY;
    else if (mainprog_ptr->pnmtype == 6) color_type = PNG_COLOR_TYPE_RGB;
    ...
    if (mainprog_ptr->gamma > 0.0) png_set_gAMA(png_ptr, info_ptr,
            mainprog_ptr->gamma);
